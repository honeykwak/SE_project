...
export const RegisterPage: React.FC = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      const credentials: RegisterCredentials = { name, email, password, username: name };
      await registerUser(credentials);
      // Sign up successful, redirect to login or dashboard
      // Assuming registerUser returns success or throws error
