...
export const replyInquiry = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    // Import dynamically to avoid circular issues or just use direct import if clean
    ...
    // Update status locally if needed, usually just log it
    // inquiry.replied = true; // If we had this field
    // await inquiry.save();
